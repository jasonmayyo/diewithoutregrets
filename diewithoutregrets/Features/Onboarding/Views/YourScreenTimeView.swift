...
struct YourScreenTimeView: View {
        ...
        GeometryReader { geometry in
            ZStack {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    Text("What does your daily screen time actually look like?")
                        .font(.system(size: 16))
                    ...
                    VStack(spacing: 10) {
                        ForEach(Array(viewModel.screenTimeOptions.enumerated()), id: \.element.id) { index, option in
                            Button(action: {
